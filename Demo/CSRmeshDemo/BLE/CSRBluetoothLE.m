...
-(void) connectPeripheral:(CBPeripheral *) peripheral {
    if ([[CSRmeshSettings sharedInstance] getBleListenMode]==CSR_SCAN_LISTEN_MODE) {
...
-(void) setScannerEnabledNotification :(NSNotification *)notification
{
    ...
    [self setScanner:enabled :[MeshServiceApi sharedInstance]];
}


    //============================================================================
    // Manage Scanner Enable/Disable control
-(void) setScanner :(BOOL) stateRequired :(id) source {
