...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([deviceEntity.appearance isEqualToNumber:@(CSRApperanceNameLight)] ||
        [deviceEntity.appearance isEqualToNumber:@(CSRApperanceNameLight2)]) {
        ...
        [cell.statusView addSubview:statusLabel];
               ...
               [deviceEntity.appearance isEqualToNumber:@(CSRApperanceNameSensor2)]) {
        ...
        cell.iconImageView.image = [CSRmeshStyleKit imageOfSensor];
               ...
               [deviceEntity.appearance isEqualToNumber:@(CSRApperanceNameHeater2)]) {
...
- (void) tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([deviceEntity.appearance isEqualToNumber:@(CSRApperanceNameSensor)] || [deviceEntity.appearance isEqualToNumber:@(CSRApperanceNameSensor2)] || [deviceEntity.appearance isEqualToNumber:@(CSRApperanceNameHeater)] || [deviceEntity.appearance isEqualToNumber:@(CSRApperanceNameHeater2)]) {
