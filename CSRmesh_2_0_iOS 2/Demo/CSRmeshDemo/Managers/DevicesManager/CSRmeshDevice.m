    ...
    [[GroupModelApi sharedInstance] getNumModelGroupIds:_deviceId
     ...
     //nGroups
                                                success:^(NSNumber *deviceId, NSNumber *modelNo, NSNumber *numberOfModelGroupIds) {
                                                    ...
                                                    NSSet *devicesSet = [[CSRDatabaseManager sharedInstance] fetchObjectsWithEntityName:@"CSRDeviceEntity" withPredicate:@"deviceId == %@", _deviceId];
                                                    CSRDeviceEntity *deviceEntity= [devicesSet anyObject];
...
- (BOOL)timedSetColor {
    ...
    [[LightModelApi sharedInstance] setColor:_deviceId
                                       color:actualColor
                                    duration:@0
...
- (BOOL)timedSetPower
{
    ...
    [[PowerModelApi sharedInstance] setPowerState:_deviceId
                                            state:powerState
