...
#define kPlaceIcons @[@{@"id":@(0), @"iconImage":@"imageOfIconHouse"}, @{@"id":@(1), @"iconImage":@"imageOfIconBuilding"}, @{@"id":@(2), @"iconImage":@"imageOfIconBoat"}, @{@"id":@(3), @"iconImage":@"imageOfIconTerrain"}, @{@"id":@(4), @"iconImage":@"imageOfIconHotel"}, @{@"id":@(5), @"iconImage":@"imageOfIconParking"}, @{@"id":@(6), @"iconImage":@"imageOfIconCity"}, @{@"id":@(7), @"iconImage":@"imageOfIconNature"}, @{@"id":@(8), @"iconImage":@"imageOfIconPublic"}, @{@"id":@(9), @"iconImage":@"imageOfIconStar"}, @{@"id":@(10), @"iconImage":@"imageOfIconDining"}, @{@"id":@(11), @"iconImage":@"imageOfIconUni"}, @{@"id":@(12), @"iconImage":@"imageOfIconShop"}, @{@"id":@(13), @"iconImage":@"imageOfIconSuitcase"}, @{@"id":@(14), @"iconImage":@"imageOfIconSun"}];
...
typedef NS_ENUM(NSUInteger, CSRApperanceName) {
    ...
    CSRApperanceNameLight2 = 10722767,
    CSRApperanceNameHeater2 = 6397401,
    CSRApperanceNameSensor2 = 302553,
    CSRApperanceNameSwitch2 = 15572441
};
