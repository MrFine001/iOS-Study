...
//                                                 
//                                             }];
    if ([_deviceEntity.favourite boolValue]) {
        [[CSRWatchManager sharedInstance] deleteFavourite:_deviceEntity.deviceId];
    }
...
- (IBAction)favouriteAction:(UIButton *)sender
{
    ...
    if (_deviceEntity) {
        ...
        // update favourite status for watch
        [[CSRWatchManager sharedInstance] updateFavourite:_deviceEntity];
